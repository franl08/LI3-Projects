...
/**
 * Class to keep Businesses Catalog
 */
public class Businesses implements BusinessesInterface, Serializable {
    /**
     * Businesses Catalog
     */
    public Hashtable<String, BusinessInterface> businessesCatalog;

    /**
     * Empty Constructor
     */
    public Businesses(){
        this.businessesCatalog = new Hashtable<>();
    }
     ...
     */
    public Hashtable<String, BusinessInterface> getBusinessesCatalog(){
        Hashtable<String, BusinessInterface> ans = new Hashtable<>();
     ...
     */
    public void setBusinessesCatalog(Hashtable<String, BusinessInterface> m){
        this.businessesCatalog = new Hashtable<>();
    ...
    public void addBusiness(BusinessInterface b){
        this.businessesCatalog.put(b.getId(), b.clone());
    }
