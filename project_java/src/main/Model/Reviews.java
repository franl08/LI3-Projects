...
/**
 * Class to keep Reviews Catalog
 */
public class Reviews implements  ReviewsInterface, Serializable {
    /**
     * Reviews Catalog
     */
    Hashtable<String, ReviewInterface> reviewsCatalog;

    /**
     * Empty Constructor
     */
    public Reviews(){
        this.reviewsCatalog = new Hashtable<>();
    }
     ...
     */
    public Hashtable<String, ReviewInterface> getReviewsCatalog(){
        Hashtable<String, ReviewInterface> ans = new Hashtable<>();
